...
checkbox.addEventListener("change", function() {
    ...
    document.getElementById("desc").innerHTML = checkbox.checked ? "I'm a web development. I'm currently training as a ''developer'' in France. I'm also a big fan of video games and manga." : "Je suis un passionné du développement web. Je suis actuellement en formation de ''développeur'' en France. Je suis également un grand fan de jeux vidéos et de manga.";
    ...
    document.getElementById("footer-txt").innerHTML = checkbox.checked ? "© 2023 Monsieur BoiBoi - This website is under my pseudonym and contains no personal information, it's a website created just for me to practice." : "© 2023 Monsieur BoiBoi - Ce site est sous mon pseudonyme et ne contient aucune information personnelle, c'est un site créé uniquement pour m'exercer.";
  });
